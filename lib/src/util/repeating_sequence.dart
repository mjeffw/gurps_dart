...
/// this class handles a common pattern in GURPS -- a point cost that follows a pattern,
/// that repeats perhaps infinitely, which the individual values in the pattern being
/// multiplied by 10 over the previous occurrence of the pattern. For example:
///
/// Pattern = 1, 3, 8
/// Sequence: 1, 3, 8, 10, 30, 80, 100, 300, 800, ...
///
/// Common usages of the pattern are to go from the index in the sequence to value
